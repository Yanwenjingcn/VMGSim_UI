...
public class DCBF_SF {
	...
	public static void outputresult(Long diff, String resultPath) {
		...
		System.out.println("DCBF_SF有" + successCount+ "个任务调度完成");
		System.out.println("DCBF_SF有" + faultCount+ "个任务调度失败》》》");

		DecimalFormat df = new DecimalFormat("0.0000");
		System.out.println("DCBF_SF:");
