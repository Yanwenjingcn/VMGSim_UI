...
public class DCMG_SF {
	...
	* @throws
	 */
	private void calculateHEFTRank(DAG dagMap) {
		...
		for(int i=taskNum-1;i>=0;i--){
			...
			for(int j=0;j<childs.size();j++){
				...
				Task childTask=getDAGById(dagId, childId);
	...
	public static void outputresult(Long diff, String resultPath) {
		...
		System.out.println("DCMG_SF有" + successCount+ "个任务调度完成");
		System.out.println("DCMG_SF有" + faultCount+ "个任务调度失败》》》");

		DecimalFormat df = new DecimalFormat("0.0000");
		System.out.println("DCMG_SF:");
